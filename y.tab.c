...
{
  "$end", "error", "$undefined", "BEG", "IF", "FOR", "WHILE", "EVAL_FUNC",
  "STRUCTURE", "ID", "INT_TYPE", "FLOAT_TYPE", "CHAR_TYPE", "STRING_TYPE",
  "BOOL_TYPE", "BOOL_VALUE", "STRING_VALUE", "INT_VALUE", "CHAR_VALUE",
  "DEFINE", "ARRAY_TYPE", "STRLEN_FUNC", "$accept", "start", YY_NULLPTR
};
#endif
